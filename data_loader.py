...
SHEET_ID = "1Dd-IMCrprwj5qxLLZbicfcKq3oTSTUhn1XOngr4l4lw"
...
def fetch_google_sheet(url: str = SHEET_XLSX_URL) -> pd.DataFrame:
...
def download_xlsx_bytes(url: str = SHEET_XLSX_URL) -> bytes:
    resp = requests.get(url, timeout=60, headers={"User-Agent": "Mozilla/5.0"})
    resp.raise_for_status()
    return resp.content
